...
pipeline {
    ...
    environment {
        ...
        git="172.17.101.191:2223/kunpeng/kp-runner.git"
        appname="kp-runner"
    }
   ...
   parameters {
        ...
        listGitBranches(
            ...
            name: 'WEBHOOK_REF',
            type: 'PT_BRANCH_TAG',
            remoteURL: 'ssh://git@172.17.101.191:2223/kunpeng/kp-runner.git',
    ...
    stages {
        ...
        stage('编译'){
            steps {
                 sh '''
                 /usr/local/go18/bin/go build -o ${collect_build_name} cmd/collect.go
                 '''
            }
        }
        ...
        when {
            ...
            steps { 
                 ansiblePlaybook( 
                	...
                	extraVars: [
                		project_name:'kp-runner',
                		deploy_path:'/data/',
                        config:"${env.WORKSPACE}/config",
